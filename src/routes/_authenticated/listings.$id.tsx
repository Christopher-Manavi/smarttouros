...
function EditListing() {
  ...
  const initial = {
    ...
    price: data.price?.toString() ?? "", beds: data.beds?.toString() ?? "",
    baths: data.baths?.toString() ?? "", sqft: data.sqft?.toString() ?? "",
    ...
    agent_name: data.agent_name ?? "", agent_phone: data.agent_phone ?? "", agent_email: data.agent_email ?? "",
    brokerage_name: data.brokerage_name ?? "", brokerage_logo_url: data.brokerage_logo_url ?? "",
    mls_number: data.mls_number ?? "",
    status: data.status, show_address_on_unbranded: data.show_address_on_unbranded ?? true,
  };
